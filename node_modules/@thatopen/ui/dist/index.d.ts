 ...
 */
export declare function calculateDividerStyles(divider: GridDividerInfo, computedStyles: CSSStyleDeclaration): Record<string, string>;
...
export declare class Chart extends LitElement {
    ...
    get data(): ChartData<Types, (number | Point | [number, number] | BubbleDataPoint | null)[], unknown>;
...
export declare type ChartLoadFunction = () => Promise<ChartInputData>;
...
export declare class Component extends LitElement {
     ...
     */
    static create<T extends HTMLElement, S extends Record<string, any>>(template: StatefullComponent<S>, state: S): [element: T, update: UpdateFunction<S>, utils: ComponentUtils<S>];
    /**
     * Creates a new UI component instance based on the provided template and initial state.
     *
     * @template T - The type of the UI component element.
 ...
 */
export declare interface ComponentUtils<S> {
...
export declare interface DataSelectedEventDetail<T extends TableRowData = TableRowData> {
    data: Partial<T>;
}
...
declare class DataSet<T> extends Set<T> {
    ...
    readonly onItemDeleted: Event_2<T>;
...
export declare interface ElementCreatedEventDetail<T extends HTMLElement = HTMLElement> {
    name: string;
    element: T;
}
...
export declare class Manager {
    ...
    static addIconsCollection(icons: Record<string, {
        body: string;
        width?: number;
        height?: number;
    }>, config?: {
...
export declare class Table<T extends TableRowData = TableRowData> extends LitElement {
    static flattenData<T extends TableRowData>(data: TableGroupData<T>[]): TableGroupData<T>[];
    /**
     * CSS styles for the component.
     */
    static styles: CSSResult[];
    ...
    defaultContentTemplate: (value: string | boolean | number, data: Partial<T>, group: TableGroup<T> | null) => TemplateResult;
    /**
...
export declare class TableCell<T extends TableRowData> extends LitElement {
    ...
    get dataTransform(): NonNullable<TableDataTransform<T>[keyof T]> | undefined;
 ...
 */
export declare type TableGroupingTransform<T extends TableRowData = TableRowData> = {
...
export declare class TableRow<T extends TableRowData> extends LitElement {
    ...
    connectedCallback(): void;
    disconnectedCallback(): void;
    dataTransform: TableDataTransform<T> | null;
    private _interval;
    private clearDataTransform;
    applyAdaptativeDataTransform(dataTransform: TableDataTransform<T>): void;
    protected render(): TemplateResult_2<1>;
}
